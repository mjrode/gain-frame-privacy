...
The proposals are nice. The saves are why I trust it.
...
Every one of those became a written rule in the procedure the same day it happened. The file has 13 of these corrections encoded now. That's the actual moat of the system, I think — the loop gets harder to fool every time it embarrasses itself, and it never needs to be taught twice. Same idea as [reading your data before building features](/blog/stop-building-features-start-reading-data/), just pointed at marketing.
