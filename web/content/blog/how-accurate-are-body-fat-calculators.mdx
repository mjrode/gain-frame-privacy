...
Under good technique, it is commonly cited as landing within roughly 3 to 4 percentage points of a DEXA reading for people in the middle of the range. That is genuinely useful for a free method involving a $5 tape. You can run the formula with your own measurements in our [U.S. Navy tape-measure body fat calculator](/tools/body-fat-estimator/).
...
For population-level screening this is fine, and it's why the approach persists in epidemiology. For an individual who cares enough to search for a body fat calculator, it fails on exactly the people most likely to be running it: anyone muscular reads too high, anyone [skinny fat](/blog/am-i-skinny-fat-quiz/) reads too low. Our full breakdown of [when BMI is accurate and when it lies](/blog/is-bmi-accurate/) covers the fair version of both cases.
