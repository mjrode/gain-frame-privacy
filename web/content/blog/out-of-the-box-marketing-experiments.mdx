...
<div className="scroll-reveal" style={{display: 'flex', flexDirection: 'column', alignItems: 'center', margin: 'var(--sp-lg) 0'}}>
  <iframe src="https://www.tiktok.com/embed/v2/7658571781023829261" title="Day 1 of my 30-day founder challenge on TikTok" loading="lazy" allow="encrypted-media; fullscreen" allowFullScreen style={{width: '325px', maxWidth: '100%', height: '740px', border: '1px solid var(--color-border)', borderRadius: '12px', overflow: 'hidden'}} />
  <p className="post-caption" style={{marginTop: '8px'}}>Day 1 of 30. <a href="https://www.tiktok.com/@gainframeapp/video/7658571781023829261" target="_blank" rel="noopener">Watch on TikTok</a> if the embed doesn't load.</p>
</div>
