...
**Want to check the claim before installing?** The [browser-based AI body fat scanner](/tools/body-fat-from-photo/) runs the same engine on one photo per day, free, no signup.
