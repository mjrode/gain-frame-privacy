...
**Platform:** [iOS only](https://apps.apple.com/us/app/gainframe-progress-photos/id6759252082)  ·  **Price:** Free (25 lifetime photos) / Pro $5.99/mo or $39.99/yr
...
**Try before you download:** the [free browser body fat estimator](/tools/body-fat-from-photo/) runs the same photo AI — one scan per day, no account.
...
<div className="blog-post-cta scroll-reveal"><h3>See Every Check-in as Data, Not Just a Photo</h3><p>GainFrame scores each check-in with AI body composition analysis — body fat %, FFMI, and 12 muscle group ratings — so you can see exactly what changed and why.</p><a href="https://apps.apple.com/us/app/gainframe-progress-photos/id6759252082" className="cta-button" target="_blank" rel="noopener">Download GainFrame Free</a></div>
