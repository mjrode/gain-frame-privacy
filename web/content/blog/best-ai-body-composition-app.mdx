...
**Try it in the browser first:** the [free AI body fat estimator](/tools/body-fat-from-photo/) runs the same engine on a single photo — one scan per day, no signup, nothing to install.
