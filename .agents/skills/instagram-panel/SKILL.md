...
bash .agents/skills/instagram-panel/generate.sh \
...
| File | Purpose |
|------|---------|
| `.agents/skills/instagram-panel/generate.sh` | Slide generator (Gemini; reads `GEMINI_API_KEY`) |
