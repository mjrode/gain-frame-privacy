...
description: "Identify and classify competitors for GainFrame using free SERP, alternative-search, and community-recommendation signals. Outputs a ranked, classified list (Direct / Adjacent / Content) ready to feed competitor-scan for deep profiling. Use when the user says \"identify competitors\", \"find competitors\", \"competitor discovery\", \"who are our competitors\", \"discover competitors\", \"/competitor-discovery\"."
---
...
- `/Users/michael.rode/code/project/gain-frame-privacy/.agents/skills/competitor-scan/SKILL.md` — downstream consumer
- `/Users/michael.rode/code/project/gain-frame-privacy/.agents/skills/keyword-discovery/SKILL.md` — secondary consumer (Content competitor list)
