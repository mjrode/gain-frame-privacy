...
description: "Codex-specific copy of the GainFrame Guy TikTok carousel workflow. Use when creating TikTok carousel posts in Codex with OpenAI GPT Image 2 (`gpt-image-2`) for slide image generation. Use when the user says \"codex tiktok\", \"codex tiktok carousel\", \"codex new tiktok\", \"codex mascot post\", \"gpt image 2 tiktok\", \"gpt-image-2 tiktok\", \"openai tiktok carousel\", \"gpt image tiktok carousel\"."
---
...
Do not edit the canonical `.agents/skills/tiktok/SKILL.md` when this skill is triggered. Treat it as source material only.
...
```
sed -n '1,999p' /Users/michael.rode/code/project/gain-frame-privacy/docs/assets/gainframe-guy/illustrations/STYLE_GUIDE.md
```
