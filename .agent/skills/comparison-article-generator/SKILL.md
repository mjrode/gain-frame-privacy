...
description: Generate "[Competitor] vs GainFrame" comparison articles that capture comparison-intent SERP traffic. Front-loaded answers, honest competitor research, mandatory comparison table + "who is each for" + FAQ blocks. Inherits voice, icons, HTML scaffold, and deploy workflow from blog-post-generator.
triggers:
  - "comparison article"
  - "vs article"
  - "compare app"
...
This skill **inherits without restating** the following sections of `.agent/skills/blog-post-generator/SKILL.md`:
