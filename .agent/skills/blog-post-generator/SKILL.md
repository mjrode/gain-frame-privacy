...
6. **Update Index:** The blog index is **manually maintained** in `web/lib/_extracted/blog-body.html` (not auto-generated, despite the file path). Insert a new `<a class="blog-card scroll-reveal">` block at the **top** of the `<div class="blog-grid margin-top-grid">` (newest first). Match the format of the surrounding cards exactly:
   ```html
   <a href="[slug]/" class="blog-card scroll-reveal">
       <div class="blog-card-image">
           <img src="[slug]/assets/cover.webp"
       ...
       <div class="blog-card-content">
           ...
           <h3>[Post Title]</h3>
           <p>[Subtitle / one-line hook]</p>
       </div>
   </a>
   ```
   Note: there is an open follow-up to auto-generate this file from `.mdx` frontmatter. Until that lands, this manual step is required or the post will be invisible from the blog index even though its detail page works fine.
