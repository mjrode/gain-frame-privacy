...
> **September 21 customer-intent execution: approved `all`.** F1/F2/F3/F5/F6/F7/F8/F9/F10 are live in `ed96f821`, verified at 100% on September 21, 13:05:01 UTC (Worker `2d757ab8-c762-487c-8a9a-7295a919311e`). Seven existing destination articles refreshed plus six contextual-link sources, setup-tool Store link corrected, rater explanation/sample added. No new URLs. [Scope and evidence](2026-09-21.md); [execution receipt](2026-09-21-execution.md). F4 was explicitly accelerated by the owner and shipped as `f1e92985` at September 21, 14:11:07 UTC; all ten improvements are complete. [F4 receipt](2026-09-21-f4-execution.md). Follow-up automation is paused. Freeze its new metadata through October 01, 14:11 UTC; sample/mixed results and exports remain separate from personal-photo activation.
> **Intent owners:** solo guide -> progress photos/gym progress photos; free roundup -> usable free options; main roundup -> paid-feature selection; body-tracking roundup -> categories and repeated physique tracking; score explainer -> interpretation; rater -> assessment. Physique tracker remains a secondary-copy hypothesis with no verified keyword conversion claim.
> **Fresh listing corrections:** Progress photos are Pro; SnapTrack imports/overlays/sharing are IAPs and its update is 2017; Fit-Stitch is now $4.99; Shapez is now FormaTrack; Hevy has private comparisons. Free app scoring exists within allowances. GainFrame's old 25-photo limit is not universal; current public copy defers to the in-app allowance.
> **Measurement:** preserve September 11 tool/blog experiment phases and September 15 Visualizer phase; content changes annotated, allocations/copy/eligibility unchanged. Freeze changed metadata through October 1, 13:05 UTC. Review September 22-October 19 with settled GSC around October 22. Comparison-tool inbounds changed before its gated product update; annotate separately. Fresh inspection is 88/89 PASS (all 15 changed URLs PASS); five-day-old Lean Body Mass Calculator remains unknown/too young. IndexNow accepted 3/5 engines; Google manual recrawl list and Bing verification remain in the execution receipt.

> **Latest execution: 2026-09-16.** Owner approved all September 16 proposals: **F1–F5, T1 and P1**. Website **`a8f5e420`** is live at 100%, deployed **17:24:07 UTC**, Worker version **`1bfe6b1f-69f3-40c3-8309-e0188c8ed561`**. Lean Body Mass Calculator and Gravl vs Fitbod are published; all five fixes and required touched-source validation repairs are complete. Full scope, evidence and follow-ups: [September 16 audit](2026-09-16.md).
> **Search baseline:** final GSC through September 13: **26,340 clicks vs 9,519 (+176.7%)**, 1,536,097 impressions, average position 6.54; latest week **9,158 vs 6,626 (+38.2%)**. Tools/directory supply 13,155 clicks and blog paths 12,014. These gains predate today's release. Full source aggregates stay under `analytics/raw/2026-09-16/seo-cycle/` locally.
> **Release evidence:** 120 tool tests, 10 report tests, 13 strict post checks and a selected-source production build pass. Eighteen live pages and all three new images verified. Fresh Google sweep: **90 existing PASS, two same-day new URLs unknown**. IndexNow accepted **3/5**; Bing verification and manual Google requests remain. [Compact release receipts](receipts/2026-09-16/).
> **Attribution:** default listing restored on all three affected surfaces; campaign labels retained. Direct/QR HTTP redirects and Swift payload contract pass. New QR visibility events preserve the encoded key without changing click/exposure denominators. iOS uses first-touch attribution. **Fresh-install AppsFlyer delivery is unverified**, so there is no install/revenue attribution claim. App operating records are reconciled in docs-only commit `66f28a53`; no iOS release.
> **Next reads:** RENPHO metadata frozen through **September 26 at 17:24 UTC**; read final September 17–26 data around **September 29**. New tool/article and full content-link window September 17–October 14, settled read around **October 17**. Existing experiment allocation, copy, eligibility and launch clocks remain unchanged. Holds remain holds. Older snapshots below are historical.


## Current action ledger (September 16, 2026)

All seven approved items shipped in `a8f5e420`; H1 remains held. Exact scopes,
anchors, sources and validation are in the September 16 audit. Search evidence
is the pre-release August 17–September 13 versus July 20–August 16 comparison.

| ID | Delivered scope | Next decision |
|---|---|---|
| F1 | Default Store routing, exact link/parser/HTTP checks, separate QR visibility event, visualizer UTC cutoff and pooled-identity repair. | Annotate September 16 coverage/routing change. Verify actual fresh-install delivery; no arm-level install or revenue conclusion yet. |
| F2 | 51/52-word Quick Answers and visible FAQ/Article parity for photo-estimation and AI-trainer articles. | Keep titles/targets. Assess citations, query coverage and onward tool use around September 29; full read October 17. |
| F3 | RENPHO exact approved same-URL title/description/social/schema test. Baseline exact query 0 clicks/340 impressions, position 10.88. | Freeze through September 26 at 17:24 UTC. Read ten full days around September 29, controlling rank/query mix. |
| F4 | Both contextual Ab Analyzer inbounds added, with existing planning/general-rater bridges retained. | Measure referred starts/results and qualified handoffs. |
| F5 | Two RIRLift comparison inbounds and canonical Article cover repaired; now three established inbounds. | Preserve targeting through its original 28-day window. |
| T1 | Lean Body Mass Calculator published with dual units, optional sensitivity and real report example; three contextual inbounds and directory/sitemap entry. | 6,600 US/month, KD 0, +124% yearly is prelaunch market evidence. Business yield unproven; result activation then qualified handoff, full settled read October 17. |
| P1 | Gravl vs Fitbod published with current primary sources, both publisher screenshots and three contextual inbounds. | 390/month, KD 0, +809% yearly; reverse wording overlaps. Preserve standalone Gravl review intent. Evaluate qualified discovery and physique-rater/Store handoffs around October 17. |
| H1 | Existing bodybuilding chart remains the query owner; no new competing URL. | Hold calculator expansion until September 9 link-change measurement matures, full read around October 10. |

### Experiment and content measurement gates

- Shared tool v4: earliest two-full-week gate **September 26**, plus **4,600 exposed per arm**, assignment-based evidence and guardrails. One crossover identity out of 1,806; exclude crossover in sensitivity reads. Body Visualizer's September 15 departure changes the page mix; excluding it throughout preserves Improve's descriptive lead (40/435 assigned vs 25/426).
- Blog v2: **September 22–26** time gate, plus **1,500 exposed per arm**. Three crossover identities out of 1,942. Inline exposure reach is 48.7%, sticky 79.8%, so compare assigned visitors as well as exposed CTR.
- Body Visualizer `four_treatments_v1`: launch receipt for commit `352ad91f` at **2026-09-15T19:27:22.736891Z**. A/B/C/D raw clickers 0/7/5/2 from 63/60/74/69 assigned; no 24-hour-mature viewers at this read. Minimum **1,600 mature viewers per arm plus 14 elapsed days**, earliest **September 29 at 19:27 UTC**; three adjusted comparisons versus A. New content full window September 16–October 13, final GSC about **October 16**. Protect URL/intent and fresh metadata while collecting.
- Compressed onboarding: 465 vs 458 exposures, below **500 per arm plus D7 maturity**. Completion 393 vs 256; score reach 374 vs 368; mature D7 paid 20/254 vs 22/258. Separate diagnostic first-week return 51/254 vs 83/258 and first-day terminal scoring failures 22/427 vs 9/432 require version/acquisition and failure-cause investigation. They are guardrail signals, not a demonstrated mechanism. Reassurance remains active; stratify by onboarding arm. C3 remains inactive.
- Annual-price experiment `exp2a2a230e34`: started **September 15, 16:39:32 UTC**, $7.99 monthly fixed and annual $49.99 control vs $39.99 treatment, annual preselected, no trial, same eligible $29.99 first-year rescue. First D28 age checkpoint **October 13**; subsequent enrollees mature later. Treatment reuses `weekly_annual_999_3999` with changed package contents: never pool with historical weekly-price cohorts. Old `expdfb28690d7` remains stopped at 69/723 vs 51/780 payers, adverse treatment conversion interval -51.3% to -3.5%.
- September 9 WHtR/measurement-link changes: directional **September 19**, ten-day **September 22**, full **October 10**. Shoulder width continues to grow; male-BF exact query is too small for a ranking decision. Withings hold remains appropriate with declining provider demand and sparse local evidence.
- August 31 tools: **September 28 plus reporting lag** and fresh SERP brief before any redesign. Progress Photo Compare's previous indexing exclusion is resolved. September post cohorts: full reads around **October 4/7/8**, depending on publication date and final-data lag. Do not republish their existing subjects as gaps.

The pre-release review inventory was 254 posts (206 SEO-category, 48 founder-category), 1,469 links, seven founder/product orphans, 49 Quick Answer issues and 80 schema issue rows. The approved release brings it to 255 posts and 1,480 links; all 13 touched posts pass strict checks. No blanket orphan fixes or title-similarity merges. Provider keyword gaps must be reconciled with actual GSC ownership: `rate my body female` already has a strong tool owner, and the shoulder-to-waist guide already embeds a calculator. All 11 SEO clusters grew; C2/C3/C11 remain the growth centers. No recurring monitor was created.
...
- **Search growth remains broad, accelerating, and nonbrand.** Search Console reached 15,272
  clicks and 888,340 impressions in 28 days, up 153% and 188%. Average position improved from
  8.38 to 7.63. Brand rows supplied 735 clicks, only 4.8% of the total; residual nonbrand clicks
  rose about 168%. The latest 14 days were also up 86% in clicks and 96% in impressions.
- **GA4 confirms engaged discovery, but downstream clicks are not keeping pace.** Organic sessions
  rose 116% to 14,504, engaged sessions rose 134%, and engagement rate improved 5.37 points.
  PostHog tool results rose across the major surfaces, but App Store clicks increased 18% over 28
  days and fell 6% in the latest 14 days. Google-referred store clicks also fell. Do not translate
  search growth into an install or revenue claim.
- **C2, C3, and C11 remain the expansion engines.** Visual-reference clicks rose 394%,
  measurement/hardware rose 248%, and physique rating rose 1,072%. Every cluster except C10 grew;
  C10 was flat and remains too adjacent to justify a Hevy or Fitbod review.
- **The best emerging keyword is physique check, but it is not a new-page opportunity.** The term
  has 140 US volume / KD 2 and reached 1 click / 352 impressions at position 8.42 from essentially
  no prior ownership. The rater article and tool both rank; physique check ai is already 4 clicks /
  51 impressions at position 4.86 on the tool. Google's live AI Overview cites both assets. Measure
  the Aug 23 change and consider a contained definition section only if CTR remains near zero or
  ownership remains fragmented. Do not create a sibling.
- **No clean net-new executable post survived.** ZOZOFIT review remains the only credible new URL:
  720 volume, +22% yearly, and a weak independent written SERP. It remains blocked on three
...
| Item | Target / evidence | State |
|---|---|---|
| F1 body-visualizer activation | 732 organic sessions, 74.2% engagement, 16 store clicks; result activation was absent | **Shipped Aug 29 in `5148b60`.** Once after an interacted valid result; properties limited to unit and reference sex |
| F2 DEXA launch quality | submitted/indexed; five FAQ/schema mismatches, two visible long dashes, noncanonical App Store href | **Shipped Aug 29 in `5148b60`.** Exact schema parity, dash normalization, and canonical href; claims and targeting preserved |
...
| Asset / change | Read | Fair date |
|---|---|---|
| Aug 26 body-visualizer page and links | exact-query clicks, CTR, position, and organic sessions | directional Sep 2-5; full Sep 23 |
| Aug 29 body-visualizer result event | valid results, result-to-CTA rate, unit/reference-sex mix | directional Sep 5; full Sep 26 |
...
### 2026-08-23 decision ledger

| Item | Target / evidence | State |
|---|---|---|
| P1 `zozofit-review` | `zozofit review`: 720, +22% yearly; distinct current review gap | **Approved, blocked.** Require three controlled app-only scans, matching tape readings, setup/failure notes, first-party workflow/output/pricing screenshots, and a first-person test interview. Without the pack: HOLD |
| F1 rater CTA bridge | ranking `rate-my-physique` pointed at BF estimator; rater tool has 1,158 GSC clicks and 1,079 scores | **Shipped 2026-08-23.** CTA now routes to `/tools/physique-rater/`; strict FAQ/schema and punctuation cleanup included |
| F2 ZOZOFIT source truth | `best-body-composition-apps` said mandatory $69 suit and made unqualified reliability claims | **Shipped 2026-08-23.** Current app-only/optional-suit workflow, plans, 16 reported sites, official sources, and estimate limitations |
| F3 InBody vs Withings section | ~99 impressions already consolidate on `best-inbody-alternatives` at positions 12–19 | **Shipped 2026-08-23.** Exact section, six-row table, matching FAQ/schema, official Withings source, and contextual review link; primary targeting metadata unchanged |
| F4 shipped-product truth | Target Training and nutrition claims were definitely stale against v3.13 | **Shipped 2026-08-23** on three mature pages; live Target Training workflow, current nutrition suite, medical hedging, and a contextual Target Training inbound. The 15-day-old leaderboard/nutrition announcement still waits until Sep 5 |
...
### Measurement windows opened 2026-08-23

| Change | Read | Fair date |
|---|---|---|
| F1 rater bridge | source-path visits to the physique rater, scores, then downstream App Store clicks | directional Aug 30; full Sep 20 |
| F2 ZOZOFIT refresh | page clicks/CTR, ZOZOFIT query mix, and downstream App Store clicks | directional Aug 30-Sep 2; full Sep 20 |
| F3 InBody-vs-Withings section | exact-family impressions, CTR, and position on the existing owner | directional Aug 30-Sep 2; full Sep 20 |
...
- **Traffic is still compounding.** 9,268 clicks / 530,287 impressions in 28d (+142% / +203%),
  non-brand ~8,581. Aug 16 set a new click record at 502 / 31,894. Sitewide CTR 1.75% (was 2.19%)
  from impression dilution, not a rank drop (position 8.45 vs 8.50).
- **Tools are the working surface.** 3,061 clicks at 12.23% CTR vs blog 4,891 at 0.98%.
  `/tools/body-fat-from-photo/` 1,539c (was 425); `/tools/physique-rater/` 826c / **23.67% CTR** /
  pos 4.0 (new); `/tools/body-fat-visualizer/` 573c. Body-visualizer is still an impression-expansion
  play (77c / pos 33.9, judge Sep 3). Ab-analyzer is 13c, all in the last 7d (judge Sep 10).
- **Conversion picked up at the 28d grain, not from the Aug 17 tool card.** PostHog
  `outbound_app_store_click` 1,229 vs 679 (+81%). Tool completions 3-4x'd (`bf_tool_result_shown`
  2,658 vs 691; `physique_rater_scored` 924 vs 0). Tool-path store clicks stayed ~11/day across
  Aug 10-16 and Aug 17-18. Aug 18 homepage is Reddit + `$direct`. Split path and referrer before
  crediting a tool CTA change.
- **Working blogs are still roundups.** `best-ai-body-fat-apps` 479c (down from 573 as the tool
  absorbed the family — net win), scanning hub 436c (was 143), editor roundup 237c / 54 store
  clicks, transformation roundup 229c. Stats pages (`average-bicep-size` 197c / 49k imp / 0.40%
  CTR) remain zero-click AEO. Do not expand the stats factory.
- **Rate-my-body sibling is HOLD, not GO.** Query×page on `rate my body`: blog 12c pos 8.4, tool
  6c pos 4.8, `ai-physique-rating-apps` 1c pos 19.6. AI variants already resolve to the tool.
  `rate-my-physique` still CTAs `/tools/body-fat-from-photo/`. Next move is F3 (swap CTA Aug 21),
  not a third URL.
- **No new blog areas this run.** DataForSEO unavailable in Cursor; no volume/KD/SERP briefs.
  Do not open a cluster. Next fair content decisions: Hume retitle Aug 19, then Sep 3-10 windows
  (visualizer, WHR/WHtR, Thelo, scales, ab-analyzer).
- **Indexing is healthy.** 10 inspected recent URLs are Submitted and indexed. One SEO-lane
  orphan: `absmaxx-vs-gainframe` (F4 inbound from `recomp-ai-vs-gainframe`). Founder orphans skipped.
- **F1 Hume retitle remains approved-scheduled for Aug 19.** Last 7d the page is 1c / 364i /
  pos 13.9; head terms still missing from the top-250 7d query report.
...
skill now requires per-candidate existence grep). **Rate-my-body sibling: HOLD as of 2026-08-18**
(tool already ranks the AI variants; next move is the Aug 21 CTA swap on `rate-my-physique`, not a
new URL).
