...
- [ ] **AI Workout Apps That Scan Your Body** (Med/30, blog-post-generator listicle) — added 2026-05-11 — TOP NEW PICK; SERP dominated by FitnessAI/TrueForm/Thelo/Zing/Fitanalysis with zero content competitor doing honest comparison; GainFrame fits keyword exactly (body scan → workout coupling via Hevy); suggested title "6 AI Workout Apps That Scan Your Body (2026)"; source: keyword-research/2026-05-11-ai-body-editor-recomp-coach.md
- [ ] **AI Physique Assessment & Body Scanner Apps** (Med/30, blog-post-generator listicle) — added 2026-05-11 — STRONG SECOND; consolidates `ai physique assessment app` + `ai body scanner app` + `ai body analysis app`; SERP = small AI rater tools (galaxy.ai, Rate My Physique, Aesthetics AI, BodyScoreAI, AestheticRank) with no major content competitor; GainFrame's AI Deep Dive (1-100 score + 12 muscle groups + BF% + FFMI) differentiates from toy raters; source: keyword-research/2026-05-11-ai-body-editor-recomp-coach.md
- [ ] **Best Body Recomposition Apps: Diet, Workout & Tracking Compared** (Med/25, blog-post-generator listicle) — added 2026-05-11 — LOWER PRIORITY; consolidates `body recomposition diet app` + `body recomposition workout app` + `best body recomposition app`; SERP entirely direct app competitors (BodyRecomp, Recomp AI, Absolute Recomp, Fitia); risk of cannibalizing existing `/blog/body-recomposition-tracker/` — frame as listicle pointing to tracker as #1; source: keyword-research/2026-05-11-ai-body-editor-recomp-coach.md

#### CTR / ranking fixes (existing posts — no new content needed)

- [ ] **[CTR] `/blog/best-ai-body-fat-apps/` title rewrite** — front-load "Best Body AI" wording; `best body ai` (392 imp pos 5.8, 6.12% CTR) + `best body ai app` (113 imp pos 4.8, 4.42% CTR) = **505 impressions / biggest single fish in the May export** — added 2026-05-11
